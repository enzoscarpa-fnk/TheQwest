...
namespace JDR.Models
{
    public class Warrior : Hero
    {
            ...
            ) : base(characterName, progression)
        {
            ...
            LowTierAttackInfo = lowTierAttackInfo ?? new AttackInfo("Shield Bash", "A stunning blow with the shield that costs stamina.", 4);
            MidTierAttackInfo = midTierAttackInfo ?? new AttackInfo("Battle Cry", "Unleashes a fearsome war cry. Your attack value is now doubled.", 12);
            UltimateAttackInfo = ultimateAttackInfo ?? new AttackInfo("Earthshatter", "A powerful ground strike that damages all enemies in range.", 24);
            InitializeStats();
        }
